...
class HeaderStyle {
  ...
  final TextFormatter? titleTextFormatterYear;

  /// Style for title Text (month-year) displayed in header.
  final TextStyle titleTextStyle;

  final TextStyle titleTextStyleYear;
  ...
  const HeaderStyle({
    ...
    this.titleTextFormatterYear,
    this.titleTextStyleYear = const TextStyle(fontSize: 17.0),
